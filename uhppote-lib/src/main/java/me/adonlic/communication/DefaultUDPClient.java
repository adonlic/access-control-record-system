...
public class DefaultUDPClient implements UDPClient {
    ...
    public DefaultUDPClient(String host, int port, Integer timeoutMillis, Integer receiveBufferSize, Integer queueSize)
        ...
        // this.socket = new DatagramSocket(port); // Bind by port is this is a server, else call an empty constructor
    ...
    public static void broadcastAndReceive(byte[] data, int port, long listeningDurationMillis, Consumer<byte[]> responseCallback) throws IOException {
        InetAddress broadcastAddress = InetAddress.getByName("192.168.1.255"); // 192.168.1.255 | 255.255.255.255
        // InetAddress broadcastAddress = InetAddress.getByName("255.255.255.255");
        // InetAddress broadcastAddress = InetAddress.getByName("192.168.40.255");
        // InetAddress broadcastAddress = InetAddress.getByName("10.22.33.255");
